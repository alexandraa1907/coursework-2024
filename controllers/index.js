...
const deleteLawyerById = async (req, res, next) => {
  await db.query(`
...
const createConsul = async (req, res, next) => {
  if (!req.body.clientName || !req.body.date) {
...
module.exports = { index, queries, createSpecial, deleteLawyerById, createLawyer, getPaymentPage, pay, createConsul };
